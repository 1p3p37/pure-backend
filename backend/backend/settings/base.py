...
https://docs.djangoproject.com/en/4/topics/settings/

For the full list of settings and their values, see
https://docs.djangoproject.com/en/4/ref/settings/
"""
...
BACKEND_SETTINGS_MODE = environ.get('BACKEND_SETTINGS_MODE').strip().lower()
...
CELERY_BEAT_SCHEDULE = {
    # ACTUAL GAS PRICE
    # 'nametask': {
    #     'task': 'dir.tasks.refresh_current_gas_price_task',
...
MAX_PAGE_SIZE = int(environ.get('MAX_PAGE_SIZE'))
